...
module.exports = {
    Isim: "kalkmazban",
    Komut: ["pashqsban", "uzaoç","forceban"],
    Kullanim: "kalkmazban <@pashqs/ID> <Sebep>",
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!uye) return message.channel.send(cevaplar.üye + ` \`${sistem.botSettings.Prefixs[0]}${module.exports.Isim} <@pashqs/ID> <Sebep>\``);
