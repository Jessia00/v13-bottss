...
module.exports = {
    ...
    Kullanim: "transfer <@pashqs/ID> <Miktar>",
    Aciklama: "",
    Kategori: "eco",
    Extend: true,
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!Gönderilen) return message.channel.send(cevaplar.üye + ` \`${sistem.botSettings.Prefixs[0]}${module.exports.Isim} <@pashqs/ID> <Miktar>\``);
